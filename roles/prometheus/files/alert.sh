...
curl -s https://raw.githubusercontent.com/MajorChowdary/labautomation/master/tools/prometheus-alert-manager/alertmanager.service >/etc/systemd/system/alertmanager.service
